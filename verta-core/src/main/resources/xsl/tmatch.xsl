...
<style>
 ...
 <div class="tabs">
    <a data-toggle="tab1">Config</a>
    <a data-toggle="tab7">Results</a>
    <a data-toggle="tab9">SENT</a>
    <a data-toggle="tab8">NEL</a>
    <a data-toggle="tab2">NERC</a>
    <a data-toggle="tab3">TIMEX</a>
    <a data-toggle="tab4">LEX</a>
    <a data-toggle="tab11">MORPH</a>
    <a data-toggle="tab10">DIST</a>
    <a data-toggle="tab5">DEPS</a>
    <a data-toggle="tab6">Ngrams</a>
...
<xsl:for-each select="//presults/lexresults">
...
<xsl:for-each select="//hyp/sen[1]/word">
     <td> <xsl:variable name="val" select="position() - 2"/><xsl:variable name="valm" select="position() - 1"/>
      ...
      <xsl:value-of select="feat[@name='WORD']"/>_<xsl:value-of select="feat[@name='POS']"/><sub><xsl:value-of select="position()"/></sub>   
     </td> 
 </xsl:for-each>        
 </tr>  
 </table>
...
<div  id="tab7"  class="tab">
 ...
 <xsl:for-each select="//presults/wmetric">
  ...
  $.fn.html5jTabs = function(options){
    return this.each(function(index, value){
      ...
      obj.click(function(evt){
        ...
        togglerRest = $(toggler).parent().find("div.tab");
...
<table border="1">
 <tr><td></td><xsl:for-each select="tw[1]/s"><th>

<!-- <div class="verticalText"><xsl:value-of select="@w"/></div> -->
...
<xsl:template name="tword">
  <xsl:param name="wid"/>
    <xsl:value-of select="//ref/sen[1]/word[position() = $wid + 1]/feat[@name='WORD']"/>_<xsl:value-of select="//ref/sen[1]/word[position() = $wid + 1]/feat[@name='POS']"/>
</xsl:template>

<xsl:template name="sword">
  <xsl:param name="wid"/>
    <xsl:value-of select="//hyp/sen[1]/word[position() = $wid + 1]/feat[@name='WORD']"/>_<xsl:value-of select="//hyp/sen[1]/word[position() = $wid + 1]/feat[@name='POS']"/> 
</xsl:template>
</xsl:stylesheet>
