...
/**
 * Straigh forward implementation of a in memory synonym dictionary using a hashset
 * 
 * @author jordi
 * 
 *
...
public class SimilaritySynonymDicc extends BaseSimilarity implements Similarity{
	...
	public double similarity(String[] featureNames, Word proposedWord,
		...
		hold =(featureProposed.equals(featureReference) || dicc.contains(featureProposed+JOINWORDS+featureReference));
		++i;
		}
