...
public class SimilarityHypernymWn extends WnBaseSimilarity implements Similarity{
	...
	public SimilarityHypernymWn(String multilevel) { MULTILEVEL=(multilevel.compareToIgnoreCase("MULTILEVEL")==0);}

//	public SimilarityHypernymWn(){}
...
//	public double INNERsimilarity(String[] featureNames, Word proposedWord, Word referenceWord) {
//		 return INNERsimilarity(featureNames, proposedWord,referenceWord,SynsetType.NOUN);
//	}
	
	public double INNERsimilarity(String[] featureNames, Word proposedWord,
			Word referenceWord,SynsetType[] lpos) {
		...
		//System.err.println("SYS COMPARE"+referenceSynsets.length+" "+proposedSynsets.length);
	...
	private boolean searchLists(JABSynset[] referenceSynsets, JABSynset[] hypos) {
		...
		//if(found) {
		//	System.err.println("**** Hyper found:"+hypos[i-1].getDefinition());
		//}
		return found;
	}
